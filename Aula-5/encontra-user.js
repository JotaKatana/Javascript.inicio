...
while (!encontrou_users) { //--> Isso continua enquanto ele não encontrar mais usuários
    const user_atual = lista_phone[contador] //--> Pode receber os nomes dos usuários
    if (user_atual.startsWith("Z")) { //--> Comece com tal letra....Se a primeira lera for igual a que eu defini vai ser true
